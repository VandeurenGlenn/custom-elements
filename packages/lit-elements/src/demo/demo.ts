  ...
  async connectedCallback() {
    ...
    const onSelected = async ({ detail }) => {
      document.dispatchEvent(
        new CustomEvent('custom-scroll', { detail: { scrolling: false } })
      );
      pages.select(detail);
      ...
      <custom-drawer-layout class="demo-container">
        ...
        <flex-column slot="drawer-content">
          <custom-selector attr-for-selected="route" default-selected="banner">
            ...
            <custom-drawer-item route="top-app-bar"
              >top-app-bar</custom-drawer-item
            >
            <custom-drawer-item route="typography"
              >typography</custom-drawer-item
            >
            <custom-drawer-item route="drawer">drawer</custom-drawer-item>
            <custom-drawer-item route="pane">pane</custom-drawer-item>
            <custom-drawer-item route="supporting-pane"
              >supporting pane</custom-drawer-item
            >
            <custom-drawer-item route="tabs">tabs</custom-drawer-item>
            <custom-drawer-item route="menu">menu</custom-drawer-item>
            <custom-drawer-item route="dropdown-menu"
              >dropdown-menu</custom-drawer-item
            >
            <custom-drawer-item route="list-item">list-item</custom-drawer-item>
            <custom-drawer-item route="toggle">toggle</custom-drawer-item>
            <custom-drawer-item route="toggle-button"
              >toggle-button</custom-drawer-item
            >
          </custom-selector>
        </flex-column>
        ...
        <flex-column>
          <custom-pages attr-for-selected="route" default-selected="banner">
            ...
            <demo-section route="cards">
              <custom-card type="filled">
                ...
                <p slot="supportingText">
                  ...
                  Similique ratione eligendi eum aliquam enim, magni beatae
                  facere tempora ex accusantium a, dolorem tempore placeat
                  laboriosam praesentium veritatis facilis et quasi? Lorem ipsum
                  dolor, sit amet consectetur adipisicing elit. Similique
                  ratione eligendi eum aliquam enim, magni beatae facere tempora
                  ex accusantium a, dolorem tempore placeat laboriosam
              ...
              <custom-card type="elevated">
                ...
                <p slot="supportingText">
                  ...
                  Similique ratione eligendi eum aliquam enim, magni beatae
                  facere tempora ex accusantium a, dolorem tempore placeat
                  laboriosam praesentium veritatis facilis et quasi?
                </p>
                <flex-row slot="actions">
            ...
            <demo-section route="drawer">
              ...
              <custom-selector>
                <custom-drawer-item id="demo-drawer"
                  >drawer-item</custom-drawer-item
                >
              </custom-selector>
            </demo-section>
            ...
            <demo-section route="dialog">
              <flex-container>
                <custom-button class="fullscreen-dialog"
                  ><custom-icon slot="icon">menu</custom-icon></custom-button
                >
                <custom-dialog fullscreen>
                  <span slot="title">title</span>
                  <p>
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                    Rerum quae ipsum autem, recusandae impedit minus cumque odit
                    vel incidunt, exercitationem sint tempore sit ea ratione
                    accusamus nemo magni dolorem corporis.
                  </p>
                  <p>
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                    Rerum quae ipsum autem, recusandae impedit minus cumque odit
                  ...
                  <flex-row slot="actions">
                    <custom-button label="agree" action="agree"
                      >agree</custom-button
                    >
                  </flex-row>
                </custom-dialog>
                ...
                <script>
                  ...
                  const fullscreenDialog = demoSection.querySelector(
                    'custom-dialog[fullscreen]'
                  );
                  demoSection
                    .querySelector('.fullscreen-dialog')
              ...
              <flex-container>
                ...
                <script>
                  const dialog = demoSection.querySelector(
