        ...
        <custom-pages attr-for-selected="route" default-selected="banner">
          ...
          <demo-section route="cards">
            <custom-card type="filled">
              ...
              <p slot="supportingText">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Similique ratione eligendi eum aliquam enim, magni beatae facere tempora ex accusantium a, dolorem tempore placeat laboriosam praesentium veritatis facilis et quasi?
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Similique ratione eligendi eum aliquam enim, magni beatae facere tempora ex accusantium a, dolorem tempore placeat laboriosam praesentium veritatis facilis et quasi?
              </p>
            ...
            <custom-card type="elevated">
              ...
              <span slot="subline">subline</span>
              <p slot="supportingText">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Similique ratione eligendi eum aliquam enim, magni beatae facere tempora ex accusantium a, dolorem tempore placeat laboriosam praesentium veritatis facilis et quasi?</p>
              <flex-row slot="actions">
            ...
            <custom-card type="tertiary">
              <img loading="lazy" slot="image" src="https://lh3.googleusercontent.com/9NBw6U14z6f-EAnwPqfcX-mIkxNdpK0IXvwiun9w84JkMcZfBT0bfRqn7QWdBVqnCYC5hsDEnGhSjbaWcgi1HT_Q6pCioSRTgMFODqZdAXw=s0">
          ...
          <demo-section route="dialog">
            <flex-container>
              ...
              <custom-dialog fullscreen>
                <span slot="title">title</span>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rerum quae ipsum autem, recusandae impedit minus cumque odit vel incidunt, exercitationem sint tempore sit ea ratione accusamus nemo magni dolorem corporis.</p>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rerum quae ipsum autem, recusandae impedit minus cumque odit vel incidunt, exercitationem sint tempore sit ea ratione accusamus nemo magni dolorem corporis.</p>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rerum quae ipsum autem, recusandae impedit minus cumque odit vel incidunt, exercitationem sint tempore sit ea ratione accusamus nemo magni dolorem corporis.</p>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rerum quae ipsum autem, recusandae impedit minus cumque odit vel incidunt, exercitationem sint tempore sit ea ratione accusamus nemo magni dolorem corporis.</p>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rerum quae ipsum autem, recusandae impedit minus cumque odit vel incidunt, exercitationem sint tempore sit ea ratione accusamus nemo magni dolorem corporis.</p>
